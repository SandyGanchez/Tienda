...
router.post('/productos', autenticar, soloAdmin, validarBody(crearProductoSchema), productosController.crear.bind(productosController));
...
router.put('/productos/:id', autenticar, soloAdmin, validarBody(actualizarProductoSchema), productosController.actualizar.bind(productosController));
