...
interface TiendaPublica { nombreSuc: string | null; logoSuc: string | null; }
...
export class ClienteShellComponent implements OnInit {
  ...
  logo(): string | null { return this.imagenes.resolver(this.tienda?.logoSuc); }
  avatar(): string | null { return this.imagenes.resolver(this.clienteAuth.sesion?.cliente.fotoPerfil); }
}
